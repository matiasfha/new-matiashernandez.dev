...
description:
  Typescript es un lenguaje compilado o transpilado que genera código Javascript,
  es decir escribirás código Typescript pero el producto final, el que se ejecuta
  es Javascript.
bannerCredit:
  <span>Photo by <a href="https://unsplash.com/@solmaz67?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">solmaz
