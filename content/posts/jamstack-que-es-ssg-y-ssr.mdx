...
description:
  Una pregunta que suele aparecer en las foros y comunidades es la comparación
  entre Gatsby y Next.js o, la subyacente pregunta. Qué es SSG y SSR? Cuál debo usar
  para X caso de uso y cómo comenzar?
bannerCredit:
  <span>Photo by <a href="https://unsplash.com/@arstyy?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Austin
