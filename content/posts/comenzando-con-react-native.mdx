...
description:
  React Native es un framework que te permite utilizar Javascript y React
  para desarrollar tu aplicación nativa. Para iniciar debes configurar algunas cosas
  primero.
bannerCredit:
  <span>Photo by <a href="https://unsplash.com/@oskaryil?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Oskar
