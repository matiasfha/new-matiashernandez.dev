...
description:
  React `useEffect` es quizá el hook que más confusiones genera a la hora
  de utilizarlo. Una confusión común es el uso del arreglo de dependencias
bannerCredit:
  <span>Photo by <a href="https://unsplash.com/@themisphotography?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Monirul
...
> Recomendado:
>
> [¿Qué son los hooks?](https://matiashernandez.dev/que-son-los-hooks)
>
...
- [Dan Abramov](https://twitter.com/dan_abramov) tiene un artículo en [profundidad sobre useEffect](<(https://kentcdodds.com/blog/react-hooks-pitfalls)>)
