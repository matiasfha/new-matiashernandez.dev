...
bannerCredit:
  <span>Photo by <a href="https://unsplash.com/@markusspiske?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Markus
...
`useEffect` se trata sobre _sincronizar_ el estado interno de un componente con algún estado externo, por ejemplo obtener datos desde una api o modificar algo en el DOM.
