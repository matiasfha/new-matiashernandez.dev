...
description:
  El uso de hooks requiere de un cambio de modelo mental, un proceso que
...
bannerCredit:
  <span>Photo by <a href="[https://unsplash.com/@brookanderson?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText](https://unsplash.com/@brookanderson?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText)">Brook
