...
const H1 = styled.h1`
  ${tw`text-gray-800 text-2xl md:text-4xl font-muli font-bold text-left self-center`}
  span {
    ${tw`no-underline text-black hover:underline cursor-pointer`}
  }
`
